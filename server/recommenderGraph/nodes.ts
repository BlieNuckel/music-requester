...
export const NODE_REGISTRY: NodeRegistration[] = [
  ...
  },
  {
    ...
    gives: "Listening that never committed as a play",
    flow: "ingestion",
    inputs: [],
...

  {
    ...
    does: ["Reads plays, ratings, the album catalogue and listening episodes"],
  ...
  },
  {
    ...
    does: ["Writes them as one row, stamped with the settings they came from"],
...

  {
    ...
    does: ["Runs once per slot", "Excludes each pick from the next"],
  ...
  },
  {
    ...
    does: ["Turns the exploration rate into a whole number of slots"],
...

  {
    ...
    takes: [
      "An album from a distant artist",
      "An album from a neighbour",
      "An album from the genre chart",
    ],
    does: ["Tries each in order, and stops at the first that answered"],
