...
const ACTION_CLASSES =
  "flex items-center justify-center w-7 h-7 rounded-lg border-2 border-black shadow-cartoon-sm hover:translate-y-[-1px] hover:shadow-cartoon-md active:translate-y-[1px] active:shadow-cartoon-pressed transition-all";
...
export default function NearbyShowCard({
  ...
  return (
    ...
    <li className="flex-1 min-h-0 flex items-center gap-2.5 rounded-lg border-2 border-black bg-amber-50 dark:bg-gray-700/40 p-1.5">
      ...
      <div className="shrink-0 flex items-center gap-1">
        <Link
          ...
          className={`${ACTION_CLASSES} bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100`}
        >
