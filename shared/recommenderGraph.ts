 ...
 *
 * Shared rather than drawn client-side, because the server serves one flow on its own to
 * anyone reading a recommendation's trace, and "which nodes is that" has to be one answer.
 */
